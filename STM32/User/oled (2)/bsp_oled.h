...
#define OLED_CS_On()	    GPIO_ResetBits(OLED_GPIO_CS_PORT, OLED_GPIO_CS_PIN)					
#define OLED_CS_Off()       GPIO_SetBits(OLED_GPIO_CS_PORT, OLED_GPIO_CS_PIN)

#define OLED_DC_On()        GPIO_SetBits(OLED_GPIO_DC_PORT,OLED_GPIO_DC_PIN)
#define OLED_DC_Off()       GPIO_ResetBits(OLED_GPIO_DC_PORT,OLED_GPIO_DC_PIN)

#define OLED_RST_On()        GPIO_SetBits(OLED_GPIO_RST_PORT,OLED_GPIO_RST_PIN)
#define OLED_RST_Off()       GPIO_ResetBits(OLED_GPIO_RST_PORT,OLED_GPIO_RST_PIN)
